...
export function IconChevronLeft({ className }: IconProps): ReactNode {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
...
export function IconChevronRight({ className }: IconProps): ReactNode {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
...
export function IconPin({ className }: IconProps): ReactNode {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
