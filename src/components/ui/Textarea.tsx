  ...
  return (
    <label className="flex w-full flex-col gap-1.5">
      ...
      <textarea
        {...props}
        className={cn(
          'min-h-[88px] w-full resize-y rounded-md border border-zinc-800 bg-zinc-950 px-3 py-2 text-[13px] text-zinc-100 outline-none placeholder:text-zinc-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 sm:text-sm',
